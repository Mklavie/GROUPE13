...
<div class="contenu">
    ...
    <div class="images">
        <div class="image">
            <h1 class="accueil-titre" >SALLE 150AFS</h1>
            <img src="image/150AFS.jpg" alt="">
            <p>une salle tres confortable avec des tables banc et un taleau verte</p>
        </div>
        <div class="image">
            <h1 class="accueil-titre">SALLE 150BFS</h1>
            <img src="image/150BFS.jpg" alt="">
            <p>une salle tres confortable avec des tables banc et un taleau blanc</p>
        </div>
        <div class="image">
            <h1 class="accueil-titre">SALLE 150CFS</h1>
            <img src="image/150CFS.jpg" alt="">
            <p>une salle tres confortable avec des tables banc et un taleau verte</p>
        </div>    
    </div>
</div>
